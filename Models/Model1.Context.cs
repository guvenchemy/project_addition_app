...
namespace project_addition_app.Models
{
    ...
    public partial class AdisyonDBEntities : DbContext
    {
        public AdisyonDBEntities()
            : base("name=AdisyonDBEntities")
        {
        }
        ...
        public virtual DbSet<AktifSiparisler_V> AktifSiparisler_V { get; set; }
        public virtual DbSet<SiparisDetaylari_V> SiparisDetaylari_V { get; set; }
        public virtual DbSet<SiparisListesi> SiparisListesis { get; set; }
        public virtual DbSet<SiparisListesi_V> SiparisListesi_V { get; set; }
